...
Другие методы: “+”, strings.Join(), fmt.Sprintf(), bytes.Buffer

Bench: [https://gist.github.com/dtjm/c6ebc86abe7515c988ec](https://gist.github.com/dtjm/c6ebc86abe7515c988ec)

strings.Builder source: [https://cs.opensource.google/go/go/+/refs/tags/go1.21.5:src/strings/builder.go](https://cs.opensource.google/go/go/+/refs/tags/go1.21.5:src/strings/builder.go)
...
source: [https://go.dev/doc/faq#overloading](https://go.dev/doc/faq#overloading)
...
***Почему***: в функцию wg передана по значению, копируется, поэтому wg.Done() выполняется только в копии. Счетчик wg в главной горутине никогда не обнулится и будет блокирока на wg.Wait.
